    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          const baseClassName = `card min-w-[22rem] min-h-[32rem] p-8 flex flex-col items-center justify-between ${textAutoHide ? "card--text-autohide" : ""} ${enableBorderGlow ? "card--border-glow" : ""}`;
          const cardProps = {
          ...
          // Adiciona a frase ao lado do Dashboard
          ...
          if (enableStars) {
            return (
              ...
              >
                <div className="card__header mb-4 -mt-2">
                ...
                <div className={`card__content${!card.description ? ' mb-8' : ''} ${(card.label === 'E-commerce' || card.label === 'Comparison' || card.label === 'Dashboard') ? ' pb-16' : ''}`}>
                  {/* Imagem centralizada */}
                  <div className="flex justify-center items-center mb-4">
                    {card.label === "E-commerce" && (
                      <img
                        src="https://res.cloudinary.com/dzwfuzxxw/image/upload/v1748972944/2025-06-03_13-54_aj7yd0.png"
                        alt="Cynthia Makes"
                        className="w-128 h-128 object-cover grayscale rounded-lg border-2 border-white/10"
                      />
                    )}
                    ...
                    {card.label === "Dashboard" && (
                      <img
                        ...
                        alt="DashMEBoard"
                        className="w-128 h-48 object-cover grayscale rounded-lg border-2 border-white/10"
                      />
                    )}
                  </div>
                  <h2 className="card__title mb-8">{card.title}</h2>
                  <p className="card__description" style={{color: 'white', fontSize: '14px', lineHeight: '1.4', marginTop: '8px'}}>{card.description}</p>
                </div>
              </ParticleCard>
            );
          }
